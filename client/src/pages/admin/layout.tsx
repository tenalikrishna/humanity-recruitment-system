...
const navItems: NavItem[] = [
  { label: "Dashboard", href: "/admin/dashboard", icon: <LayoutDashboard size={18} />, roles: ["admin", "core_team", "screener"] },
  { label: "Applicants", href: "/admin/applicants", icon: <ClipboardList size={18} />, roles: ["admin", "core_team"] },
  { label: "Team", href: "/admin/users", icon: <UserCog size={18} />, roles: ["admin"] },
];
